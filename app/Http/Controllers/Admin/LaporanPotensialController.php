...
class LaporanPotensialController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.konflik-potensial.index', compact('laporan'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.konflik-potensial.show', compact('laporan', 'dokumen'));
    }
