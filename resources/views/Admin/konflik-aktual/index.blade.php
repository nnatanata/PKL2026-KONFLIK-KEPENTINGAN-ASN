...
<div class="toolbar-container">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li>
                <a class="dropdown-item" href="{{ route('konflik-aktual.index', array_merge(request()->except(['sort_by', 'sort_order']), [])) }}">
                    Clear Sort
                </a>
            </li>
            <li><hr class="dropdown-divider"></li>
            <li>
                <a class="dropdown-item" href="{{ route('konflik-aktual.index', array_merge(request()->all(), ['sort_by' => 'la.tanggal_aktual', 'sort_order' => 'desc'])) }}">
                    Tanggal Terbaru
                </a>
            </li>
            <li>
                <a class="dropdown-item" href="{{ route('konflik-aktual.index', array_merge(request()->all(), ['sort_by' => 'la.tanggal_aktual', 'sort_order' => 'asc'])) }}">
                    Tanggal Terlama
                </a>
            </li>
            <li>
                <a class="dropdown-item" href="{{ route('konflik-aktual.index', array_merge(request()->all(), ['sort_by' => 'peg.nama', 'sort_order' => 'asc'])) }}">
                    Nama Pelapor (A-Z)
                </a>
            </li>
            <li>
                <a class="dropdown-item" href="{{ route('konflik-aktual.index', array_merge(request()->all(), ['sort_by' => 'peg.nama', 'sort_order' => 'desc'])) }}">
                    Nama Pelapor (Z-A)
                </a>
            </li>
        </ul>
    ...
    <div style="position: relative;">
        ...
        <div class="filter-panel" id="filterPanel">
            ...
            <form id="filterForm" action="{{ route('konflik-aktual.index') }}" method="GET">
                @if(request('search'))
                ...
                <div class="filter-actions">
                    <a href="{{ route('konflik-aktual.index', request()->only('search')) }}" class="btn-filter-action btn-filter-reset">
                        Reset All
                    </a>
                ...
                <tr onclick="window.location='{{ route('konflik-aktual.show', $item->id) }}'">
                    ...
                    <td class="text-center">
                        <span class="badge-status 
                            {{ $item->status_aktual == 'Disetujui' ? 'status-disetujui' : '' }}
                            {{ $item->status_aktual == 'Diproses' ? 'status-diproses' : '' }}
                            {{ $item->status_aktual == 'Ditolak' ? 'status-ditolak' : '' }}
                        ">
                            {{ $item->status_aktual }}
                        </span>
                    </td>
                    <td class="text-center" onclick="event.stopPropagation()">
                        ...
                        <form action="{{ route('konflik-aktual.destroy', $item->id) }}" 
                              method="POST" 
                              class="d-inline"
