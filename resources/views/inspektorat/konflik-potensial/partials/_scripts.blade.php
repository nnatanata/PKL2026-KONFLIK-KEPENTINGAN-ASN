...
function viewDocument(docId, filename, fileType) {
    ...
    // ⚠️ PERBEDAAN: dokumen-potensial (bukan dokumen-aktual)
    downloadBtn.href = `/inspektorat/dokumen-potensial/${docId}/download`;
    ...
    // ⚠️ PERBEDAAN: dokumen-potensial (bukan dokumen-aktual)
    const viewUrl = `/inspektorat/dokumen-potensial/${docId}/view`;
