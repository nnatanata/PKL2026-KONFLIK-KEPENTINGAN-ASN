...
<div class="toolbar-container">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li>
                <a class="dropdown-item" href="{{ route('inspektorat.konflik-potensial.index', array_merge(request()->except(['sort_by', 'sort_order']), [])) }}">
                    Clear Sort
                </a>
            </li>
            <li><hr class="dropdown-divider"></li>
            <li>
                <a class="dropdown-item" href="{{ route('inspektorat.konflik-potensial.index', array_merge(request()->all(), ['sort_by' => 'lp.tanggal_potensial', 'sort_order' => 'desc'])) }}">
                    Tanggal Terbaru
                </a>
            </li>
            <li>
                <a class="dropdown-item" href="{{ route('inspektorat.konflik-potensial.index', array_merge(request()->all(), ['sort_by' => 'lp.tanggal_potensial', 'sort_order' => 'asc'])) }}">
                    Tanggal Terlama
                </a>
            </li>
            <li>
                <a class="dropdown-item" href="{{ route('inspektorat.konflik-potensial.index', array_merge(request()->all(), ['sort_by' => 'peg.nama', 'sort_order' => 'asc'])) }}">
                    Nama Pelapor (A-Z)
                </a>
            </li>
            <li>
                <a class="dropdown-item" href="{{ route('inspektorat.konflik-potensial.index', array_merge(request()->all(), ['sort_by' => 'peg.nama', 'sort_order' => 'desc'])) }}">
                    Nama Pelapor (Z-A)
                </a>
            </li>
        </ul>
    ...
    <div style="position: relative;">
        ...
        <div class="filter-panel" id="filterPanel">
            ...
            <form id="filterForm" action="{{ route('inspektorat.konflik-potensial.index') }}" method="GET">
                @if(request('search'))
                ...
                <div class="filter-group">
                    ...
                    <select class="filter-select" name="status">
                        ...
                        <option value="Disetujui" {{ request('status') == 'Disetujui' ? 'selected' : '' }}>Disetujui Verifikator</option>
                        <option value="Disetujui Inspektorat" {{ request('status') == 'Disetujui Inspektorat' ? 'selected' : '' }}>Disetujui Inspektorat</option>
                ...
                <div class="filter-actions">
                    <a href="{{ route('inspektorat.konflik-potensial.index', request()->only('search')) }}" class="btn-filter-action btn-filter-reset">
                        Reset All
                    </a>
...
<div class="table-container">
    <div class="table-header">
        ...
        <a href="{{ route('inspektorat.konflik-potensial.export', request()->all()) }}" 
           class="btn-export">
    ...
    <div class="table-responsive">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr onclick="window.location='{{ route('inspektorat.konflik-potensial.show', $item->id) }}'">
                    ...
                    <td class="text-center">
                        <span class="badge-status 
                            {{ $item->status_potensial == 'Disetujui' ? 'status-disetujui-verifikator' : '' }}
                            {{ $item->status_potensial == 'Disetujui Inspektorat' ? 'status-disetujui-inspektorat' : '' }}
                            {{ $item->status_potensial == 'Ditolak Inspektorat' ? 'status-ditolak' : '' }}
                        ">
                            {{ $item->status_potensial == 'Disetujui' ? 'Disetujui Verifikator' : $item->status_potensial }}
                        </span>

                    </td>

                    <td class="text-center" onclick="event.stopPropagation()">
                        <a href="{{ route('inspektorat.konflik-potensial.show', $item->id) }}" 
...
<script>
    ...
    function executeDelete() {
        if (deleteItemId) {
            ...
            form.action = `/inspektorat/konflik-potensial/${deleteItemId}`;
            form.submit();
        }
    }
