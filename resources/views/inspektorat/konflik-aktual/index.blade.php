...
<div class="toolbar-container">
    ...
    <div class="search-wrapper">
        ...
        <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Cari dengan kata kunci Nama Pelapor, Sumber Konflik, atau Nama Pelaku..." 
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li>
                <a class="dropdown-item" href="{{ route('inspektorat.konflik-aktual.index', array_merge(request()->except(['sort_by', 'sort_order']), [])) }}">
                    Clear Sort
                </a>
            </li>
            <li><hr class="dropdown-divider"></li>
            <li>
                <a class="dropdown-item" href="{{ route('inspektorat.konflik-aktual.index', array_merge(request()->all(), ['sort_by' => 'la.tanggal_aktual', 'sort_order' => 'desc'])) }}">
                    Tanggal Terbaru
                </a>
            </li>
            <li>
                <a class="dropdown-item" href="{{ route('inspektorat.konflik-aktual.index', array_merge(request()->all(), ['sort_by' => 'la.tanggal_aktual', 'sort_order' => 'asc'])) }}">
                    Tanggal Terlama
                </a>
            </li>
            <li>
                <a class="dropdown-item" href="{{ route('inspektorat.konflik-aktual.index', array_merge(request()->all(), ['sort_by' => 'peg.nama', 'sort_order' => 'asc'])) }}">
                    Nama Pelapor (A-Z)
                </a>
            </li>
            <li>
                <a class="dropdown-item" href="{{ route('inspektorat.konflik-aktual.index', array_merge(request()->all(), ['sort_by' => 'peg.nama', 'sort_order' => 'desc'])) }}">
                    Nama Pelapor (Z-A)
                </a>
            </li>
        </ul>
    ...
    <div style="position: relative;">
        ...
        <div class="filter-panel" id="filterPanel">
            ...
            <form id="filterForm" action="{{ route('inspektorat.konflik-aktual.index') }}" method="GET">
                @if(request('search'))
                ...
                <div class="filter-actions">
                    <a href="{{ route('inspektorat.konflik-aktual.index', request()->only('search')) }}" class="btn-filter-action btn-filter-reset">
                        Reset All
                    </a>
...
<script>
    ...
    function executeDelete() {
        if (deleteItemId) {
            ...
            form.action = `/inspektorat/konflik-aktual/${deleteItemId}`;
            form.submit();
        }
    }
