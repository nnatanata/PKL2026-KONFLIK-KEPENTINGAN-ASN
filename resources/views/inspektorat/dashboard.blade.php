...
@section('title', 'Dashboard Inspektorat')
@section('breadcrumb')
...
<div class="row mb-4">
    <div class="col-md-4">
        <div class="stat-card">
            <div class="stat-label">Disetujui Inspektorat</div>
            <div class="stat-number text-success">{{ $diproses }}</div>
            <small class="text-muted">Total Laporan Disetujui Inspektorat</small>
        </div>
    </div>
    <div class="col-md-4">
        <div class="stat-card">
            <div class="stat-label">Disetujui Verifikator</div>
            <div class="stat-number text-warning">{{ $disetujui }}</div>
            <small class="text-muted">Total Laporan Disetujui Verifikator</small>
        </div>
    </div>
    <div class="col-md-4">
        <div class="stat-card">
...
<script>
    ...
    function updateChart() {
        ...
        fetch(`/inspektorat/api/dashboard/chart-data?tahun=${year}`, {
            headers: {
