...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'SIMAKK ASN - Inspektorat')</title>
...
<div id="sidebar" class="sidebar">
    ...
    <a href="{{ route('inspektorat.dashboard') }}" class="{{ request()->routeIs('inspektorat.dashboard') ? 'active' : '' }}">
    ...
    <div class="collapse {{ request()->is('inspektorat/konflik-*') ? 'show' : '' }}" id="menuKonflik">
        <a href="{{ route('inspektorat.konflik-aktual.index') }}" 
           class="{{ request()->routeIs('inspektorat.konflik-aktual.*') ? 'active' : '' }}">
            <i class="bi bi-dot"></i> 
            <span class="menu-text">Konflik Aktual</span>
        </a>
        <a href="{{ route('inspektorat.konflik-potensial.index') }}" 
           class="{{ request()->routeIs('inspektorat.konflik-potensial.*') ? 'active' : '' }}">
            <i class="bi bi-dot"></i> 
...
<div id="topbar" class="topbar">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="dropdownUser">
            <li>
                <a class="dropdown-item" href="{{ route('inspektorat.profile.index') }}">
